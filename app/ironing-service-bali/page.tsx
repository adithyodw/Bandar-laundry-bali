...
const serviceData = {
  ...
  desc: "Professional steam ironing for shirts, trousers, dresses, and formal wear. Delivered crisp, neat, and ready to wear.",
  price: "Ironing: Rp 35.000 / 5kg",
  features: ["Steam ironing", "Formal & casual wear", "Shirts, trousers, dresses", "Estimated 1 x 24 hours", "Hanger service option"],
  longDesc:
  ...
  benefits: [
    ...
    { title: "Fast Turnaround", desc: "Estimated completion is 1 x 24 hours from the time your order receipt is created." },
