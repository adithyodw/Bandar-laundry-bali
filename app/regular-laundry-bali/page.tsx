...
export const metadata: Metadata = {
  ...
  description:
    "Affordable drop-off laundry service in Bali. Full wash, dry, and fold with careful attention to fabrics. Drop Off Rp 45.000 / 5kg at Bandar Laundry Express.",
};
...
const serviceData = {
  ...
  benefits: [
    { title: "Affordable Price", desc: "Drop Off package is Rp 45.000 / 5kg for great everyday value." },
